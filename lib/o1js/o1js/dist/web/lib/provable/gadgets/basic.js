...
import { FieldType, FieldConst, } from '../core/fieldvar.js';
...
// internal
export { reduceToScaledVar, toLinearCombination, emptyCell, linear, bilinear, ScaledVar, };
/**
 * Assert multiplication constraint, `x * y === z`
 */
function assertMul(x, y, z) {
...
function linear(x, [a, b]) {
    ...
    // a*x - z + b === 0
    Gates.generic({ left: a, right: 0n, out: -1n, mul: 0n, const: b }, { left: x, right: emptyCell(), out: z });
    return z;
}
/**
